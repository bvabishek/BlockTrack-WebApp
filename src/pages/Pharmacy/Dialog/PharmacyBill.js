              ...
              <Col lg="12">
                ...
                <Row>
                  <Col>
                    ...
                    <br />
                    <input type="timestamp" id="created_at" value={data.created_at} onChange={e=>onChange(e)}></input>
                  </Col>
                  <Col>
                    <label>Bill Basic ID</label>
                    <br />
                    <input id="pharmacy_bill_basic_id" value={data.pharmacy_bill_basic_id} onChange={e=>onChange(e)}></input>
                  </Col>
                </Row>
                <br />
                <Row>
                ...
                <Row>
                  <Col lg="5">
                    ...
                    <br />
                    <input type="file" style={{ width: "80%" }} id="medicine_image" value={data.medicine_image} onChange={e=>onChange(e)}></input>
                  </Col>
