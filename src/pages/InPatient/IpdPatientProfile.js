                      ...
                      <Row>
                        <Col lg="6" className="mt-3">
                          <Row>
                            ...
                            <div className="d-flex justify-content-end" style={{position: 'relative', bottom: '60px'}}>
                              <button className="btn btn-warning" onClick={handleOpenDischarge}><i className="fa fa-bed"></i></button>
                              <DischargedPatientDialog open={openDischarge} handleClose={handleCloseDischarge}/>
                              </div>
